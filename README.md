# ImageGallery REST API

ImageGallery is a simple cloud application developed with cloud automation process using circleci continuous integration and continuos development to AWS ElasticBeanstalk service and s3 bucket for image storage. The application simply allows users to register and log into a web client, post photos to the feed, and process photos using an image filtering microservice.
